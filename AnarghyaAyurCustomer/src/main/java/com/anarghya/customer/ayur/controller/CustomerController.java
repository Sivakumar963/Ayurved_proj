...
public class CustomerController {
	...
	/****************************
	 * Method: addNewCustomers Description: It is used to add into the customers
	 * table
	 * 
...
// =========================================================================================================================================	
	...
	/****************************
	 * Method: Update customers Description: It is used to update customers in
	 * customers table
	 * 
	 * @returns customers It returns String type message
	 ...
	 *              URI expression.
	 * @RequestBody: It used to bind the HTTP request/response body with a domain
	 *               object in method parameter or return type. Created By-naveen
	 * 
	 ****************************/
...
// ========================================================================================================================================		
	...
	/****************************
	 * Method: viewAllCustomer Description: It is used to get All Customer items in
	 * Customer table
	 * 
...
// ========================================================================================================================================
	...
	/****************************
	 * Method: viewCustomer by Id Description: It is used to get Customer items by
	 * specifying Id in Customer table
	 * 
	 * @returns Customer It returns Customer with details
	 * @GetMapping: It is used to handle the HTTP POST requests matched with given
	 *              URI expression.
	...
	/****************************
	 * Method: viewCustomer by emailId Description: It is used to get Customer items
	 * by specifying emailId in Customer table
	 * 
	 * @returns Customer It returns Customer with details
	 * @GetMapping: It is used to handle the HTTP POST requests matched with given
	 *              URI expression.
	...
	/****************************
	 * Method: deleteCustomer Description: It is used to remove the items in the
	 * customer table
	 * 
	...
	/****************************
	 * Method: loginCustomer Description: It is used to login and redirected to
	 * Respected Location if the details in customer table are true
	 * 
	 * @returns customer It returns String type message
	 * @PostMapping: It is used to handle the HTTP POST requests matched with given
	 *               URI expression.
	...
	/****************************
	 * Method: resetPassword Description: It is used to reset the password if the
	 * customer forgets his old password
	 * 
	 * @returns customer It returns String type message
	 * @PutMapping: It is used to handle the HTTP POST requests matched with given
	 *              URI expression.
	...
	/****************************
	 * Method: newPassword Description: It is used to change the old password to new
	 * password by using entering otp
	 * 
	 * @returns customer It returns String type message
	 * @PutMapping: It is used to handle the HTTP POST requests matched with given
	 *              URI expression.
	...
	/****************************
	 * Method: viewCustomerbyEmailId Description: It is used to view the details of
	 * customer based on emailId
	 * 
	 * @returns customer It returns String type message
	 * @GetMapping: It is used to handle the HTTP POST requests matched with given
	 *              URI expression.
	...
	/****************************
	 * Method: updateCustomerEmail Description: This update method is only
	 * applicable for updating the customer Information in the frontend customer
	 * dashboard profile
	 * 
	 * @returns customer It returns String type message
	 * @PutMapping: It is used to handle the HTTP POST requests matched with given
